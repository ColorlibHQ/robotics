...
// image default alt
if( ! function_exists( 'robotics_img_default_alt' ) ) {
	function robotics_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'robotics_img_tag' ) ) {
	function robotics_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = robotics_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'robotics_anchor_tag' ) ) {
	function robotics_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'robotics' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'robotics_heading_tag' ) ) {
	function robotics_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'robotics' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'robotics_paragraph_tag' ) ) {
	function robotics_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'robotics_other_tag' ) ) {
	function robotics_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'robotics_button_element ' ) ) {
	function robotics_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'robotics' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
