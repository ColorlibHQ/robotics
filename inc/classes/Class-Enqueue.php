...
class Robotics_Enqueue {

	public $scripts = array();

	public function robotics_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'robotics_frontend_enqueue_scripts', ) );
	}

	public function robotics_frontend_enqueue_scripts( ) {
