...
function robotics_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'robotics' ),
        'next_string'     => esc_html__( '&raquo;', 'robotics' ),
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'robotics_pagination_defaults', $defaults )
    );
