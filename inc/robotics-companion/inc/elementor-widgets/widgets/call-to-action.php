...
class Robotics_Cta extends Widget_Base {
	...
	public function get_title() {
		return __( 'Call To Action', 'robotics' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'cta_content',
            [
                'label' => __( 'Call To Action Content', 'robotics' ),
            ]
        );
        $this->add_control(
            'title',
            [
                ...
                'label_block' => true,
                'default' => esc_html__( 'Everything You can imagine is right here', 'robotics' )
            ]
        );
        $this->add_control(
            'btnlabel',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Reach Our Support Team', 'robotics' )
            ]
        );
        $this->add_control(
            'btnurl',
