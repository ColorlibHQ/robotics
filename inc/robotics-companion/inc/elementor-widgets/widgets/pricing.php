...
class Robotics_Pricing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pricing Table', 'robotics' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'pricing_tblhead',
            [
                'label' => __( 'Table Heading', 'robotics' ),
            ]
        );
        $this->add_control(
            'pricing_title',
        ...
        $this->add_control(
            'pricing_subtitle',
            [
                'label' => esc_html__( 'Sub Title', 'robotics' ),
                'type'  => Controls_Manager::TEXT,
            ]
        );
        $this->add_control(
            'pricing_packno',
            [
                'label' => esc_html__( 'Package No', 'robotics' ),
                'type'  => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->start_controls_section(
            'pricing_tblprice',
            [
                'label' => __( 'Price Info', 'robotics' ),
            ]
        );
        $this->add_control(
            'pricing_price',
            [
                'label' => esc_html__( 'Price', 'robotics' ),
                'type'  => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->start_controls_section(
            'pricing_tblbutton',
            [
                'label' => __( 'Button', 'robotics' ),
            ]
        );
        $this->add_control(
            'pricing_btnlabel',
            [
                'label' => esc_html__( 'Label', 'robotics' ),
                'type' => Controls_Manager::TEXT,
            ]
        );
        $this->add_control(
        ...
        $this->start_controls_section(
            'style_tblheading', [
                'label' => __( 'Style Table Heading', 'robotics' ),
        ...
        $this->add_control(
            'color_hovertitle', [
                'label'     => __( 'Hover Title Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_number', [
                'label'     => __( 'Number Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_hoversubtitle', [
                'label'     => __( 'Hover Sub Title Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ffffff',
                'selectors' => [
        ...
        $this->add_control(
            'color_feature', [
                'label'     => __( 'Feature Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
        ...
        $this->add_control(
            'color_hoverfeature', [
                'label'     => __( 'Hover Feature Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnlabel', [
                'label'     => __( 'Button Label Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#222',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnhoverlabel', [
                'label'     => __( 'Button Hover Label Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnborder', [
                'label'     => __( 'Button Border Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#00ff8c',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnhovborder', [
                'label'     => __( 'Button Hover Border Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#00ff8c',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnbg', [
                'label'       => __( 'Button Background Color', 'robotics' ),
                'type'        => Controls_Manager::COLOR,
                'selectors'   => [
        ...
        $this->add_control(
            'color_btnhovbg', [
                'label'     => __( 'Button Hover Background Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#00ff8c',
                'selectors' => [
