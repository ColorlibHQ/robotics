...
class Robotics_Banner extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'banner_content',
            [
                'label' => __( 'Banner Section Content', 'robotics' ),
            ]
        );
        $this->add_control(
            'banner_titleone',
            [
                'label'         => esc_html__( 'Title #1', 'robotics' ),
                'type'          => Controls_Manager::TEXT,
                'default'       => esc_html__( 'Don\'t look further, here is the key', 'robotics' ),
                'label_block'   => true
            ]
        );
        $this->add_control(
            'banner_desc',
            [
                'label'         => esc_html__( 'Description', 'robotics' ),
                'type'          => Controls_Manager::WYSIWYG,
                'default'       => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim. sed do eiusmod tempor incididunt.', 'robotics' ),
            ]
        );
        $this->add_control(
            'banner_btnlabel',
            [
                ...
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__( 'View Details', 'robotics' )
            ]
        );
        $this->add_control(
            'banner_btnurl',
        ...
        $this->add_control(
            'color_titleone', [
                'label'     => __( 'Title #1 Color', 'robotics' ),
        ...
        $this->add_control(
            'color_titletwo', [
                'label'     => __( 'Title #2 Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
