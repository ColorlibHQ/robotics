...
class Robotics_Events extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'events_heading',
            [
                'label' => __( 'Events Section Heading', 'robotics' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'events_content',
			[
				'label' => __( 'Events', 'robotics' ),
			]
		);
		$this->add_control(
            'events_content_rep', [
                'label' => __( 'Create events', 'robotics' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'date',
                        'label' => __( 'Date', 'robotics' ),
                        'type'  => Controls_Manager::DATE_TIME
                    ],
                    [
                        'name'  => 'location',
                        'label' => __( 'Location', 'robotics' ),
                        'type'  => Controls_Manager::TEXT,
                    ...
                    [
                        'name'  => 'btnlabel',
                        'label' => __( 'Button Label', 'robotics' ),
                        'type'  => Controls_Manager::TEXT,
                    ],
                    [
                        'name'  => 'btnurl',
    ...
    $this->start_controls_section(
        'style_eventbox', [
            'label' => __( 'Style Event Content', 'robotics' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]
    );
    $this->add_control(
                ...
                ?>
                    <div class="col-lg-6<?php echo esc_attr( $eventClass ); ?>">
                        <div class="single-events upcoming-wrap">
                            ...
                            echo sprintf( '<p class="meta">%s %s %s</p>', $date, __( 'at', 'robotics' ), $location );
                            // Content
                            if( ! empty( $val['desc'] ) ) {
