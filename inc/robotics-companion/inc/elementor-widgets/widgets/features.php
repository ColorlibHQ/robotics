...
class Robotics_Features extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'features_heading',
            [
                'label' => __( 'Features Section Heading', 'robotics' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->add_control(
            'features_content', [
                'label' => __( 'Create Features', 'robotics' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'btn_text',
                        'label' => __( 'Button Text', 'robotics' ),
                        'type'  => Controls_Manager::TEXT,
                        'default' => esc_html__( 'View Details', 'robotics' )
                    ],
                    [
                        'name'  => 'btn_url',
                        'label' => __( 'Button Url', 'robotics' ),
                        'type'  => Controls_Manager::TEXT,
                    ],
                    [
                        'name'  => 'img',
                        'label' => __( 'Img', 'robotics' ),
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'robotics' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Feature Title ', 'robotics' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Font Icon', 'robotics' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_fonticon', [
                'label'     => __( 'Font Icon Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#A7A7A7',
                'selectors' => [
        ...
        $this->add_control(
            'color_fonthovericon', [
                'label'     => __( 'Font Icon Hover Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'fontsize',
            [
                'label' => __( 'Icon Font Size', 'robotics' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Descriptions', 'robotics' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
