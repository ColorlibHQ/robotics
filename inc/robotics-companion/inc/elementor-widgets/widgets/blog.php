...
class Robotics_Blog extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'blog_content',
            [
                'label' => __( 'Blgo', 'robotics' ),
            ]
        );
        $this->add_control(
            'blog_sectiontitle',
            [
                'label'       => esc_html__( 'Section Title', 'robotics' ),
                'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__( 'Section Sub Title', 'robotics' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
            ]
        );
        $this->add_control(
            'blog_limit',
            [
                'label'     => esc_html__( 'Post Limit', 'robotics' ),
                'type'      => Controls_Manager::TEXT,
                'default'   => 3
            ]
        );
        ...
        $this->add_control(
            'color_blogtitle', [
                'label'     => __( 'Blog Title Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#222',
                'selectors' => [
        ...
        $this->add_control(
            'color_blogtitlehov', [
                'label'     => __( 'Blog Title Hover Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#222',
                'selectors' => [
        ...
        $this->add_control(
            'color_blogtext', [
                'label'     => __( 'Blog Text Color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
       ...
       /**
        ...
        $this->start_controls_section(
            'buttonstyle', [
                'label' => __( 'Tag Button Style', 'robotics' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
