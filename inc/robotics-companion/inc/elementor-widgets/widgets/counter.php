...
class Robotics_Counter extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'counter_content',
            [
                'label' => __( 'Counter', 'robotics' ),
            ]
        );
        $this->add_control(
            'counter', [
                'label' => __( 'Create Counter', 'robotics' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'    => 'number',
                        'label'   => __( 'Number', 'robotics' ),
                        'type'    => Controls_Manager::TEXT,
                        'default' => '2536'
                    ],
                    [
                        'name'    => 'unit',
                        'label'   => __( 'Unit', 'robotics' ),
                        'type'    => Controls_Manager::TEXT,
                        'default' => ''
                    ]
                ],
        ...
        $this->start_controls_section(
            'style_counter', [
                'label' => __( 'Style Counter', 'robotics' ),
