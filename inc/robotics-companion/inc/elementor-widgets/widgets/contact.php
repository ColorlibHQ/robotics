...
class Robotics_Contact extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'contact_map',
            [
                'label' => __( 'Map Settings', 'robotics' ),
            ]
        );
        $this->add_control(
            'map_switch',
            [
                'label' => __( 'Show Map', 'robotics' ),
        ...
        $this->add_control(
            'map_address',
            [
                'label'         => esc_html__( 'Address', 'robotics' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__( 'Rabindra Sorobor Dhanmondi Lake Rd', 'robotics' ),
                'description'   => esc_html__( 'Before use map widget make sure you are set google map api key from customizer -> theme options -> general -> google map api key', 'robotics' )
            ]
        );
        $this->add_control(
            'map_lat',
            [
                'label'       => esc_html__( 'Latitude', 'robotics' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( '23.745227', 'robotics' )
            ]
        );
        $this->add_control(
            'map_lng',
            [
                'label'       => esc_html__( 'Longitude', 'robotics' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( '90.377155', 'robotics' )
            ]
        );
        ...
        $this->start_controls_section(
            'contact_info',
            [
                'label' => __( 'Contact Info', 'robotics' ),
            ]
        );

        $this->add_control(
            'info', [
                'label'         => __( 'Create Contact Info', 'robotics' ),
                ...
                'fields'  => [
                    [
                        ...
                        'label_block' => true,
                        'type'        => Controls_Manager::TEXT,
                        'default'     => esc_html__( 'Dhaka, Bangladesh', 'robotics' )
                    ],
                    [
                        'name'    => 'desc',
                        'label'   => __( 'Contact Descriptions', 'robotics' ),
                        'type'    => Controls_Manager::WYSIWYG,
                        'default' => esc_html__( 'Write something...', 'robotics' )
                    ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Icon', 'robotics' ),
        ...
        $this->start_controls_section(
            'contact_form',
            [
                'label' => __( 'Contact Form', 'robotics' ),
            ]
        );
        $this->add_control(
            'contact_formshortcode',
            [
                'label'     => esc_html__( 'Form Shortcode', 'robotics' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true
            ]
        );
        ...
        $this->add_control(
            'color_subtitle', [
                'label'     => __( 'Sub title color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
        ...
        $this->start_controls_section(
            'style_content_color', [
                'label' => __( 'Style Content Color', 'robotics' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'color_border', [
                'label'     => __( 'Heading color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ffffff',
                'selectors' => [
        ...
        $this->add_control(
            'color_fbtntextcolor', [
                'label'     => __( 'Form Button Label color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#222222',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnhovlc', [
                'label'     => __( 'Form Button Hover Label color', 'robotics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#00ff8c',
                'selectors' => [
