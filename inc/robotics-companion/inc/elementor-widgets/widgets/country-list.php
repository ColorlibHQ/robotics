...
class Robotics_Country_List extends Widget_Base {
	...
	public function get_title() {
		return __( 'Country List', 'robotics' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Country List Section Heading', 'robotics' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'country_list_block',
			[
				'label' => __( 'Country List', 'robotics' ),
			]
		);
		$this->add_control(
            'country_content', [
                'label' => __( 'Create Country List', 'robotics' ),
        ...
        $this->start_controls_section(
            'style_country', [
                'label' => __( 'Style Country', 'robotics' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
                    ...
                    <div class="single-country-list">
                        ...
                        if( ! empty( $country['url']['url'] ) ) {
                            echo robotics_anchor_tag(
                                array(
                                    'text' => esc_html__( 'View Details', 'robotics' ),
