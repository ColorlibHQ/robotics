...
class robotics_newsletter_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Robotics ] Newsletter Form', 'robotics' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'robotics' ), )
        );
    ...
    <div id="mc_embed_signup" class="single-footer-widget newsletter">
        <form target="_blank" novalidate action="<?php echo esc_url( $actionurl ); ?>" id="mc-embedded-subscribe-form" method="post" class="navbar-form">
            ...
            <div class="col-lg-8 col-md-12">
                <input type="email" name="EMAIL" placeholder="<?php esc_html_e( 'Email address', 'robotics' ); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required>
            </div>
    ...
    if ( isset( $instance[ 'title' ] ) ) {
        ...
        $title = esc_html__( 'Newsletter', 'robotics' );
    }
    ...
    ?>
        ...
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'robotics'); ?></label>
        <p> <?php echo esc_html__('Enter here your MailChimp action URL.', 'robotics') ?></p>
        ...
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'desc' ) ); ?>"><?php esc_html_e( 'Short Description:' ,'robotics'); ?></label>
