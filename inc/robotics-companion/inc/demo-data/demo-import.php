...
function robotics_import_files() {
	...
	$demoImg = '<img src="'. ROBOTICS_COMPANION_DIR_URL . 'inc/demo-data/screen-image.png" alt="'.esc_attr__( 'Demo Preview Imgae', 'robotics' ).'" />';
  ...
  return array(
    array(
      ...
      'import_customizer_file_url'   => ROBOTICS_COMPANION_DIR_URL . 'inc/demo-data/robotics-customizer.dat',
...
function robotics_import_plugin_page_setup( $default_settings ) {
	...
	$default_settings['page_title']  = esc_html__( 'One Click Demo Import' , 'robotics' );
	$default_settings['menu_title']  = esc_html__( 'Import Demo Data' , 'robotics' );
...
function robotics_demo_import_custom_scripts(){
	...
	if( isset( $_GET['page'] ) && $_GET['page'] == 'robotics-demo-import' ){
		// style
		wp_enqueue_style( 'robotics-demo-import', ROBOTICS_COMPANION_DIR_URL . 'inc/demo-data/css/demo-import.css', array(), '1.0', false );
	}
